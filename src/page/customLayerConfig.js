...
export default {
  ...
  '5efc8b59-f4d8-411a-b9ea-422b1a368b4d': (data, w, h, z, params = { startDate: '2001-01-01', endDate: '2017-12-01' }) => {
    const components = 4;
    const exp = z < 11 ? 0.3 + ((z - 3) / 20) : 1;
  ...
  'dd5df87f-39c2-4aeb-a462-3ef969b20b66': (data, w, h, z, params = { minDate: '2015-01-01', startDate: '2016-12-01' }) => {
    // fixed variables
    const imgData = data;
